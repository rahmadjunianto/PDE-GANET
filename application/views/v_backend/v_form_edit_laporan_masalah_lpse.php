          ...
          <div class="">
            <div class="clearfix"></div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Data Laporan Masalah LPSE</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo base_url();?>backend/form_laporan_masalah_lpse/update_data_masalah_lpse" method="post">
                            <?php
    if(isset($tampildata)){ 
...
<input id="middle-name"  class="form-control col-md-7 col-xs-12" type="hidden" name="id_masalah" value="<?php echo $m->id_masalah;?>" >
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="nohp" value="<?php echo $m->nohp;?>"nohp>
                        </div>
                      </div>
                       <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">E-mail</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="email" value="<?php echo $m->email;?>"email>
                        </div>
                      </div>
                      <div class="form-group">
                ...
                <option value="Lainnya: ">Lainnya:</option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-xs-12">
                            ...
                            <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="ins" value="<?php echo $m->nm_ins;?>">
                        </div>
                      </div>
                      <div class="form-group">
...
?></textarea>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <?php 
if   ($m->nm_status=='belum dikerjakan') {
