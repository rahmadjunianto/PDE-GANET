            ...
            <div class="clearfix"></div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo base_url();?>backend/form_laporan_masalah_lpse/insert_data_masalah_lpse" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="nohp" value="">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">E-mail</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="email" value="">
                        </div>
                      </div>
                      <div class="form-group">
                ...
                <option value="Lainnya: ">Lainnya:</option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-xs-12">
                          <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="ins" value="">
                        </div>
                      </div>
                      <div class="form-group">
    ...
    ?> 
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="radio" class="flat" name="status" id="genderF" value="2" /> Proses
                     </div>
