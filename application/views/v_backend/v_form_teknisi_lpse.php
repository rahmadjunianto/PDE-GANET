...
<a class="btn btn-mini btn-primary" href="<?php $a=$row->id_masalah; echo base_url('backend/form_teknisi_lpse/page_detail_masalah_lpse/'.$a);?>"> <i class="fa fa fa-th-list btn-primary"></i></a>    
