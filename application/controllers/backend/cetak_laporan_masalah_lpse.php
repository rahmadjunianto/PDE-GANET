...
class Cetak_laporan_masalah_lpse extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('v_backend/v_cetak_laporan_masalah_lpse');
	...
	public function cetak_laporan()
	{
		...
		$data = array(
			...
			'cetak'=>$this->m_cetak_laporan_masalah->cetak_lpse( $this->input->post('awal'),$this->input->post('akhir'))
		 );
